...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // MODIFICA: La logica per l'indicatore "sta scrivendo" ora usa i wrapper
    ...
    function showLoadingAnimation() {
        ...
        setTimeout(() => { const loadingContainer = document.getElementById('loading-container'); if (loadingContainer) { loadingContainer.classList.add('visible'); } }, 10);
    }
    ...
    // MODIFICA: Rimosso il testo ridondante dall'evento click
