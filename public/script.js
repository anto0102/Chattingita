  ...
  <header class="header-main">
    <nav class="navbar">
        ...
        <div class="nav-links" id="nav-links">
            ...
            <a href="#settings-section" class="nav-btn" data-section="settings" id="settingsNavBtn">
  ...
  <main class="container">
      ...
      <div id="settings-section" class="content-section">
          <div class="settings-content">
              <h3><i class="fas fa-cog"></i> Impostazioni Utente</h3>
              ...
              <button id="saveSettingsBtn" class="control-btn primary"><i class="fas fa-arrow-left"></i> Torna alla Chat</button>
          </div>
      </div>
  </main>
